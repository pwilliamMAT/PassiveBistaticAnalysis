function helperCreateG2CustomerFlowPpt(layout, pptPath, pngPath)
%HELPERCREATEG2CUSTOMERFLOWPPT Create the customer-facing G2 PPT and PNG.
...
try
    ...
    error("helperCreateG2CustomerFlowPpt:GenerationFailed", ...
